 ...
 * @e_ident: A pointer to an array containing all the ELF magic numbers.
 *
 ...
 * @e_ident: A pointer to an array containing all the ELF class.
 */
void print_class(unsigned char *e_ident)
{
	printf("  Class:                             ");
 ...
 *   * @e_ident: A pointer to an array containing all the ELF version.
 */
void print_version(unsigned char *e_ident)
{
	printf("  Version:                           %d",
 ...
 * @e_ident: A pointer to an array containing all the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
 ...
 * @elf: it isThe file descriptor of the ELF file.
 *
